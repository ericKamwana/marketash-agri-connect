      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="order-1 md:order-2">
            <img 
              src="public/lovable-uploads/7a6a6541-f937-424f-98be-96ac0598c079.png" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            <img 
              src="public/lovable-uploads/8af2dcba-8380-4d97-a576-89892f33f768.png" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            <img 
              src="public/lovable-uploads/886026ce-b5a2-4592-abdb-7d9ca442eed3.png" 
